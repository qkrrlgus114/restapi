...
import com.park.restapi.domain.user.repository.EmailConfirmRepository;
import com.park.restapi.domain.user.repository.UserRepository;
import com.park.restapi.domain.user.service.EmailService;
...
public class EmailServiceImpl implements EmailService {
    ...
    public boolean sendSimpleMessageRegist(String to)throws Exception {
        Optional<User> byEmail = userRepository.findByEmail(to);
