...
public class PostLikeServiceImpl implements PostLikeService {
    ...
    public void likePost(Long postId, Member member) {
        ...
        if (post.getMember().equals(member)) {
            throw new PostLikeException(PostLikeExceptionInfo.DO_NOT_SELF_LIKE, member.getId() + "번 유저가 본인의 게시글 좋아요를 눌렀습니다.");
        }
    ...
    public void unlikePost(Long postId, Member member) {
        ...
        Optional<PostLike> byMemberAndPost = postLikeRepository.findByMemberAndPost(member, post);
